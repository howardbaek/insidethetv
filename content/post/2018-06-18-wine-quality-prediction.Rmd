...
_Since the target variable is binary, I fit a logistic regression._
...
The first hypothesis yields an accuracy rate of 71.5%! while the first hypothesis yields 70.8%!
Apparently, including all the variables yields higher accuracy.
