...
author: Howard Baik
date: '2019-04-12'
slug: animating-expected-possession-value-in-the-nba
categories:
  - R
tags:
...
authors: []
lastmod: '2019-08-18T22:00:07+09:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/epv-equation.png){width=650px height=70px}


A snapshot of a single possession in a game between the Spurs and Thunder illustrates the practicality of EPV: 

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/paper-figure1.png){width=650px height=500px}
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/paper-figure2.png){width=650px height=320px}

The above graph is best explained by the authors:

> Consider the following possession from the Spurs/Cavaliers game on February 13, 2013. Down by 2 with less than 10 seconds left, the Spurs inbounded to Tony Parker, who drove to the basket, drawing defenders into the paint and leaving Kawhi Leonard wide open in the corner. Instead of attempting the tightly contested layup that would tie the game, Parker dished to a wide-open Leonard, who promptly sank the game-winning 3-pointer, almost unchallenged by the defense. While Leonard's 3-pointer was this possession's (and game's) âcheckmateâ, we see from Figure 2
how valuable Parker was in setting it up. Parker actually dramatically increased the value of the possession twice â first by driving towards the basket, and then by passing to Leonard.
...
The code used in this post is stored [here](https://github.com/howardbaik/nba-animation/blob/master/final-result.Rmd)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/gamefilm-228.gif)

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/anim-228.GIF)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/gamefilm-229.gif)

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/anim-229.GIF)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/gamefilm-230.gif)

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/anim-230.GIF)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/gamefilm-231.gif)

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/anim-231.GIF)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/chalmers-celebration.gif)
...
![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/static-228-v5.png){width=550px height=340px}


### Wide Open 3-point Shot from Dwayne Wade

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/static-229.png){width=550px height=340px}


### Kevin Garnett Shot from the Paint

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/static-230.png){width=550px height=340px}


### Frantic Action leading to Chalmers 3-Pointer

![](/post/2019-04-12-animating-expected-possession-value-in-the-nba_files/static-231.png){width=550px height=340px}
