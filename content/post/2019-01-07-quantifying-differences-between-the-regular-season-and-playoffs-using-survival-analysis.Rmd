---
title: Quantifying Differences between the Regular Season and Playoffs using Survival
  Analysis
author: Howard Baik
date: '2019-01-07'
slug: quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis
categories:
  - R
tags:
  - Hockey Analytics
subtitle: ''
summary: 'From a casual fan perspective, the intensity traditionally ramps up in the playoffs because teams are closer to the grand prize, the Stanley Cup.'
authors: []
lastmod: '2019-08-17T22:10:19+09:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
<p align="center">
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/intro.gif)
</p>
...
<p align="center">
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/survival-curve-sample.png){width=300px height=200px}
</p>
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/pbp-sample.png){width=600px height=200px}
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/survival-data-sample.png){width=600px height=200px}
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/hazard-ratio-5v5.png){width=600px height=400px}
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/hazard-ratio-pp.png){width=600px height=400px}
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/survival-curve-5v5.png){width=600px height=400px}
...
![](/post/2019-01-07-quantifying-differences-between-the-regular-season-and-playoffs-using-survival-analysis_files/survival-curve-pp.png){width=600px height=400px}
...
[Code](https://github.com/howardbaik/insidethetv-code/blob/master/diff-regular-season-playoffs-nhl.Rmd)