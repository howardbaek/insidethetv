---
title: Hacking the NHL PBP App in Shiny
author: Howard Baik
date: '2019-02-04'
slug: hacking-the-nhl-pbp-app-in-shiny
categories:
  - R
tags:
  - Hockey Analytics
subtitle: ''
summary: 'I will walk through a month-long process building the National Hockey League Play-by-Play App from scratch, giving a behind-the-scenes look.'
authors: []
lastmod: '2019-08-18T22:15:20+09:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
I created a web application for interactively visualizing shot data for all games in the 2017-2018 season. In this article, I will walk through a month-long process building the [National Hockey League Play-by-Play App](https://jsonbaik.shinyapps.io/nhl-pbp/) from scratch, giving a behind-the-scenes look.
...
![Figure 1: Snapshot of raw shot data by Corsica](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/shot-location-table.png){width=620px height=180px}
...
<p align="center">
![Tyreek Hill's TD reception during Week 1 of 17/18 season](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/nfl-bigdata-bowl.gif)
</p>
...
![Figure 3: Data Processed for animation](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/animation-processed-table.png){width=620px height=180px}
...
<p align="center">
![Figure 4: Animation of a Regular Season Game between the Toronto Maple Leafs and the Winnipeg Jets](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/example-shot-animation.gif)
</p>
...
<p align="center">
![Figure 5: Animation of Expected Goal Probability during a Regular Season Game between the Toronto Maple Leafs and the Winnipeg Jets](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/goal-prob-anim.gif)
</p>
...
![Figure 6: Illustration of the rintrojs package](/post/2019-02-04-hacking-the-nhl-pbp-app-in-shiny_files/rintrojs-example.gif)


The final product is available here: [NHL Play-by-Play App](https://jsonbaik.shinyapps.io/nhl-pbp/)
