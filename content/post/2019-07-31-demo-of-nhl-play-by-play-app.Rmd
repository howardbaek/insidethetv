...
author: Howard Baik
date: '2019-07-31'
slug: demo-of-nhl-play-by-play-app
categories:
  - R
tags:
  - Hockey Analytics
subtitle: ''
summary: 'In this post, I will be showing insights from looking at a regular season game between the Montreal Canadiens and the Toronto Maple Leafs on October 3rd, 2018.'
authors: []
lastmod: '2019-07-31T15:29:27-04:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
![](/post/2019-07-31-demo-of-nhl-play-by-play-app_files/shot-chart.png){width=400px height=400px}
...
![](/post/2019-07-31-demo-of-nhl-play-by-play-app_files/interactive-shot.gif)
...
![](/post/2019-07-31-demo-of-nhl-play-by-play-app_files/shot-animation.gif)
...
![](/post/2019-07-31-demo-of-nhl-play-by-play-app_files/goal-probability.gif)
...
![](/post/2019-07-31-demo-of-nhl-play-by-play-app_files/nhl-recap.gif)
